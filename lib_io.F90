...
# endif
  ...
  character(len = *), parameter:: ARRAY_DESCRIPTION_FILE = 'description.txt'
    ...
    interface write_array
      module procedure write_arrayCharacterDim1LenAsterisk
    end interface write_array

    interface read_array
      module procedure read_arrayCharacterDim1LenAsterisk
    end interface read_array

    interface read_array_v_1
      module procedure read_array_v_1CharacterDim1LenAsterisk
    end interface read_array_v_1
    interface write_array
      module procedure write_arrayCharacterDim2LenAsterisk
    end interface write_array

    interface read_array
      module procedure read_arrayCharacterDim2LenAsterisk
    end interface read_array

    interface read_array_v_1
      module procedure read_array_v_1CharacterDim2LenAsterisk
    end interface read_array_v_1
    interface write_array
      module procedure write_arrayCharacterDim3LenAsterisk
    end interface write_array

    interface read_array
      module procedure read_arrayCharacterDim3LenAsterisk
    end interface read_array

    interface read_array_v_1
      module procedure read_array_v_1CharacterDim3LenAsterisk
    end interface read_array_v_1
    interface write_array
      module procedure write_arrayCharacterDim4LenAsterisk
    end interface write_array

    interface read_array
      module procedure read_arrayCharacterDim4LenAsterisk
    end interface read_array

    interface read_array_v_1
      module procedure read_array_v_1CharacterDim4LenAsterisk
    end interface read_array_v_1
    interface write_array
      module procedure write_arrayCharacterDim5LenAsterisk
    end interface write_array

    interface read_array
      module procedure read_arrayCharacterDim5LenAsterisk
    end interface read_array

    interface read_array_v_1
      module procedure read_array_v_1CharacterDim5LenAsterisk
    end interface read_array_v_1
    interface write_array
      module procedure write_arrayCharacterDim6LenAsterisk
    end interface write_array

    interface read_array
      module procedure read_arrayCharacterDim6LenAsterisk
    end interface read_array

    interface read_array_v_1
      module procedure read_array_v_1CharacterDim6LenAsterisk
    end interface read_array_v_1
    interface write_array
      module procedure write_arrayCharacterDim7LenAsterisk
    end interface write_array

    interface read_array
      module procedure read_arrayCharacterDim7LenAsterisk
    end interface read_array

    interface read_array_v_1
      module procedure read_array_v_1CharacterDim7LenAsterisk
    end interface read_array_v_1
...
# endif
  ...
  function number_of_columns(fileName, numberOfHeaders) result(this)
    ...
    subroutine write_arrayCharacterDim1LenAsterisk(arrayDir, array, desc1, desc2, desc3, desc4, desc5, desc6, desc7, desc8, desc9, desc10)
      character(len = *), intent(in):: arrayDir
      ...
      open(newunit = wU1, file = s(arrayDir) + '/' + ARRAY_DESCRIPTION_FILE, status = 'replace', action = 'write')
        ...
        if(present(desc10)) write(wU1, *) desc10
      close(wU1)
    end subroutine write_arrayCharacterDim1LenAsterisk

    subroutine read_arrayCharacterDim1LenAsterisk(arrayDir, array)
      character(len = *), intent(in):: arrayDir
    ...
    end subroutine read_arrayCharacterDim1LenAsterisk

    subroutine read_array_v_1CharacterDim1LenAsterisk(arrayDir, array)
      character(len = *), intent(in):: arrayDir
      Character(len = *), dimension(:), intent(out), allocatable:: array
      ...
      open(newunit = rU1, file = s(arrayDir) + '/' + ARRAY_DATA_FILE, status = 'old', action = 'read', form = 'unformatted', access = 'stream')
      read(rU1) array
    end subroutine read_array_v_1CharacterDim1LenAsterisk
    subroutine write_arrayCharacterDim2LenAsterisk(arrayDir, array, desc1, desc2, desc3, desc4, desc5, desc6, desc7, desc8, desc9, desc10)
      character(len = *), intent(in):: arrayDir
      Character(len = *), dimension(:, :), intent(in):: array
        character(len = *), intent(in), optional:: desc1, desc2, desc3, desc4, desc5, desc6, desc7, desc8, desc9, desc10
      ...
      open(newunit = wU1, file = s(arrayDir) + '/' + ARRAY_DESCRIPTION_FILE, status = 'replace', action = 'write')
        ...
        if(present(desc10)) write(wU1, *) desc10
      close(wU1)
    end subroutine write_arrayCharacterDim2LenAsterisk

    subroutine read_arrayCharacterDim2LenAsterisk(arrayDir, array)
      character(len = *), intent(in):: arrayDir
      Character(len = *), dimension(:, :), intent(out), allocatable:: array
    ...
    end subroutine read_arrayCharacterDim2LenAsterisk

    subroutine read_array_v_1CharacterDim2LenAsterisk(arrayDir, array)
      character(len = *), intent(in):: arrayDir
      Character(len = *), dimension(:, :), intent(out), allocatable:: array
      ...
      open(newunit = rU1, file = s(arrayDir) + '/' + ARRAY_DATA_FILE, status = 'old', action = 'read', form = 'unformatted', access = 'stream')
      read(rU1) array
    end subroutine read_array_v_1CharacterDim2LenAsterisk
    subroutine write_arrayCharacterDim3LenAsterisk(arrayDir, array, desc1, desc2, desc3, desc4, desc5, desc6, desc7, desc8, desc9, desc10)
      character(len = *), intent(in):: arrayDir
      Character(len = *), dimension(:, :, :), intent(in):: array
        character(len = *), intent(in), optional:: desc1, desc2, desc3, desc4, desc5, desc6, desc7, desc8, desc9, desc10
      ...
      open(newunit = wU1, file = s(arrayDir) + '/' + ARRAY_DESCRIPTION_FILE, status = 'replace', action = 'write')
        ...
        if(present(desc10)) write(wU1, *) desc10
      close(wU1)
    end subroutine write_arrayCharacterDim3LenAsterisk

    subroutine read_arrayCharacterDim3LenAsterisk(arrayDir, array)
      character(len = *), intent(in):: arrayDir
      Character(len = *), dimension(:, :, :), intent(out), allocatable:: array
    ...
    end subroutine read_arrayCharacterDim3LenAsterisk

    subroutine read_array_v_1CharacterDim3LenAsterisk(arrayDir, array)
      character(len = *), intent(in):: arrayDir
      Character(len = *), dimension(:, :, :), intent(out), allocatable:: array
      ...
      open(newunit = rU1, file = s(arrayDir) + '/' + ARRAY_DATA_FILE, status = 'old', action = 'read', form = 'unformatted', access = 'stream')
      read(rU1) array
    end subroutine read_array_v_1CharacterDim3LenAsterisk
    subroutine write_arrayCharacterDim4LenAsterisk(arrayDir, array, desc1, desc2, desc3, desc4, desc5, desc6, desc7, desc8, desc9, desc10)
      character(len = *), intent(in):: arrayDir
      Character(len = *), dimension(:, :, :, :), intent(in):: array
        character(len = *), intent(in), optional:: desc1, desc2, desc3, desc4, desc5, desc6, desc7, desc8, desc9, desc10
      ...
      open(newunit = wU1, file = s(arrayDir) + '/' + ARRAY_DESCRIPTION_FILE, status = 'replace', action = 'write')
        ...
        if(present(desc10)) write(wU1, *) desc10
      close(wU1)
    end subroutine write_arrayCharacterDim4LenAsterisk

    subroutine read_arrayCharacterDim4LenAsterisk(arrayDir, array)
      character(len = *), intent(in):: arrayDir
      Character(len = *), dimension(:, :, :, :), intent(out), allocatable:: array
    ...
    end subroutine read_arrayCharacterDim4LenAsterisk

    subroutine read_array_v_1CharacterDim4LenAsterisk(arrayDir, array)
      character(len = *), intent(in):: arrayDir
      Character(len = *), dimension(:, :, :, :), intent(out), allocatable:: array
      ...
      open(newunit = rU1, file = s(arrayDir) + '/' + ARRAY_DATA_FILE, status = 'old', action = 'read', form = 'unformatted', access = 'stream')
      read(rU1) array
    end subroutine read_array_v_1CharacterDim4LenAsterisk
    subroutine write_arrayCharacterDim5LenAsterisk(arrayDir, array, desc1, desc2, desc3, desc4, desc5, desc6, desc7, desc8, desc9, desc10)
      character(len = *), intent(in):: arrayDir
      Character(len = *), dimension(:, :, :, :, :), intent(in):: array
        character(len = *), intent(in), optional:: desc1, desc2, desc3, desc4, desc5, desc6, desc7, desc8, desc9, desc10
      ...
      open(newunit = wU1, file = s(arrayDir) + '/' + ARRAY_DESCRIPTION_FILE, status = 'replace', action = 'write')
        ...
        if(present(desc10)) write(wU1, *) desc10
      close(wU1)
    end subroutine write_arrayCharacterDim5LenAsterisk

    subroutine read_arrayCharacterDim5LenAsterisk(arrayDir, array)
      character(len = *), intent(in):: arrayDir
      Character(len = *), dimension(:, :, :, :, :), intent(out), allocatable:: array
    ...
    end subroutine read_arrayCharacterDim5LenAsterisk

    subroutine read_array_v_1CharacterDim5LenAsterisk(arrayDir, array)
      character(len = *), intent(in):: arrayDir
      Character(len = *), dimension(:, :, :, :, :), intent(out), allocatable:: array
      ...
      open(newunit = rU1, file = s(arrayDir) + '/' + ARRAY_DATA_FILE, status = 'old', action = 'read', form = 'unformatted', access = 'stream')
      read(rU1) array
    end subroutine read_array_v_1CharacterDim5LenAsterisk
    subroutine write_arrayCharacterDim6LenAsterisk(arrayDir, array, desc1, desc2, desc3, desc4, desc5, desc6, desc7, desc8, desc9, desc10)
      character(len = *), intent(in):: arrayDir
      Character(len = *), dimension(:, :, :, :, :, :), intent(in):: array
        character(len = *), intent(in), optional:: desc1, desc2, desc3, desc4, desc5, desc6, desc7, desc8, desc9, desc10
      ...
      open(newunit = wU1, file = s(arrayDir) + '/' + ARRAY_DESCRIPTION_FILE, status = 'replace', action = 'write')
        ...
        if(present(desc10)) write(wU1, *) desc10
      close(wU1)
    end subroutine write_arrayCharacterDim6LenAsterisk

    subroutine read_arrayCharacterDim6LenAsterisk(arrayDir, array)
      character(len = *), intent(in):: arrayDir
      Character(len = *), dimension(:, :, :, :, :, :), intent(out), allocatable:: array
    ...
    end subroutine read_arrayCharacterDim6LenAsterisk

    subroutine read_array_v_1CharacterDim6LenAsterisk(arrayDir, array)
      character(len = *), intent(in):: arrayDir
      Character(len = *), dimension(:, :, :, :, :, :), intent(out), allocatable:: array
      ...
      open(newunit = rU1, file = s(arrayDir) + '/' + ARRAY_DATA_FILE, status = 'old', action = 'read', form = 'unformatted', access = 'stream')
      read(rU1) array
    end subroutine read_array_v_1CharacterDim6LenAsterisk
    subroutine write_arrayCharacterDim7LenAsterisk(arrayDir, array, desc1, desc2, desc3, desc4, desc5, desc6, desc7, desc8, desc9, desc10)
      character(len = *), intent(in):: arrayDir
      Character(len = *), dimension(:, :, :, :, :, :, :), intent(in):: array
        character(len = *), intent(in), optional:: desc1, desc2, desc3, desc4, desc5, desc6, desc7, desc8, desc9, desc10
      ...
      open(newunit = wU1, file = s(arrayDir) + '/' + ARRAY_DESCRIPTION_FILE, status = 'replace', action = 'write')
        ...
        if(present(desc10)) write(wU1, *) desc10
      close(wU1)
    end subroutine write_arrayCharacterDim7LenAsterisk

    subroutine read_arrayCharacterDim7LenAsterisk(arrayDir, array)
      character(len = *), intent(in):: arrayDir
      Character(len = *), dimension(:, :, :, :, :, :, :), intent(out), allocatable:: array
    ...
    end subroutine read_arrayCharacterDim7LenAsterisk

    subroutine read_array_v_1CharacterDim7LenAsterisk(arrayDir, array)
      character(len = *), intent(in):: arrayDir
      Character(len = *), dimension(:, :, :, :, :, :, :), intent(out), allocatable:: array
      ...
      open(newunit = rU1, file = s(arrayDir) + '/' + ARRAY_DATA_FILE, status = 'old', action = 'read', form = 'unformatted', access = 'stream')
      read(rU1) array
    end subroutine read_array_v_1CharacterDim7LenAsterisk
end module lib_io
