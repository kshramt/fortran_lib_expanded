...
contains
   ...
   subroutine get_data_itime_(self, value)
      ...
      function get_data_ixy(self) result(value)
         ...
         ASSERT(allocated(self%data%ixy))
         value = self%data%ixy
         ASSERT(size(value, 1) == get_npts(self))
      ...
      function get_data_iamph(self) result(value)
         ...
         ASSERT(allocated(self%data%iamph))
   ...
   subroutine get_data_ixy_or_iamph_or_ixyz_(self, value)
      ...
      function is_iftype_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%iftype, ENUMERATED_VALUES, 1)
      ...
      function is_idep_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%idep, ENUMERATED_VALUES, 1)
      ...
      function is_iztype_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%iztype, ENUMERATED_VALUES, 1)
      ...
      function is_ihdr4_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%ihdr4, ENUMERATED_VALUES, 1)
      ...
      function is_iinst_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%iinst, ENUMERATED_VALUES, 1)
      ...
      function is_istreg_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%istreg, ENUMERATED_VALUES, 1)
      ...
      function is_ievreg_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%ievreg, ENUMERATED_VALUES, 1)
      ...
      function is_ievtyp_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%ievtyp, ENUMERATED_VALUES, 1)
      ...
      function is_iqual_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%iqual, ENUMERATED_VALUES, 1)
      ...
      function is_isynth_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%isynth, ENUMERATED_VALUES, 1)
      ...
      function is_imagtyp_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%imagtyp, ENUMERATED_VALUES, 1)
      ...
      function is_imagsrc_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%imagsrc, ENUMERATED_VALUES, 1)
      ...
      function is_ihdr13_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%ihdr13, ENUMERATED_VALUES, 1)
      ...
      function is_ihdr14_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%ihdr14, ENUMERATED_VALUES, 1)
      ...
      function is_ihdr15_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%ihdr15, ENUMERATED_VALUES, 1)
      ...
      function is_ihdr16_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%ihdr16, ENUMERATED_VALUES, 1)
      ...
      function is_ihdr17_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%ihdr17, ENUMERATED_VALUES, 1)
      ...
      function is_ihdr18_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%ihdr18, ENUMERATED_VALUES, 1)
      ...
      function is_ihdr19_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%ihdr19, ENUMERATED_VALUES, 1)
      ...
      function is_ihdr20_defined(self) result(ret)
         ...
         ret = &
            ...
            .and. check_bound(self%meta%ihdr20, ENUMERATED_VALUES, 1)
