...
contains
      ...
      subroutine pushRealDim0KindREAL32Stack(stack, value)
      ...
      function popRealDim0KindREAL32Stack(stack, value) result(isSuccess)
         type(RealDim0KindREAL32Stack), intent(inout):: stack
      ...
      function is_emptyRealDim0KindREAL32Stack(stack) result(answer)
      ...
      subroutine pushRealDim0KindREAL64Stack(stack, value)
      ...
      function popRealDim0KindREAL64Stack(stack, value) result(isSuccess)
         type(RealDim0KindREAL64Stack), intent(inout):: stack
      ...
      function is_emptyRealDim0KindREAL64Stack(stack) result(answer)
         type(RealDim0KindREAL64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim0KindREAL64Stack
      subroutine pushRealDim0KindREAL128Stack(stack, value)
      ...
      function popRealDim0KindREAL128Stack(stack, value) result(isSuccess)
         type(RealDim0KindREAL128Stack), intent(inout):: stack
      ...
      function is_emptyRealDim0KindREAL128Stack(stack) result(answer)
         type(RealDim0KindREAL128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim0KindREAL128Stack
      subroutine pushRealDim1KindREAL32Stack(stack, value)
      ...
      function popRealDim1KindREAL32Stack(stack, value) result(isSuccess)
         type(RealDim1KindREAL32Stack), intent(inout):: stack
      ...
      function is_emptyRealDim1KindREAL32Stack(stack) result(answer)
         type(RealDim1KindREAL32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim1KindREAL32Stack
      subroutine pushRealDim1KindREAL64Stack(stack, value)
      ...
      function popRealDim1KindREAL64Stack(stack, value) result(isSuccess)
         type(RealDim1KindREAL64Stack), intent(inout):: stack
      ...
      function is_emptyRealDim1KindREAL64Stack(stack) result(answer)
         type(RealDim1KindREAL64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim1KindREAL64Stack
      subroutine pushRealDim1KindREAL128Stack(stack, value)
      ...
      function popRealDim1KindREAL128Stack(stack, value) result(isSuccess)
         type(RealDim1KindREAL128Stack), intent(inout):: stack
      ...
      function is_emptyRealDim1KindREAL128Stack(stack) result(answer)
         type(RealDim1KindREAL128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim1KindREAL128Stack
      subroutine pushRealDim2KindREAL32Stack(stack, value)
      ...
      function popRealDim2KindREAL32Stack(stack, value) result(isSuccess)
         type(RealDim2KindREAL32Stack), intent(inout):: stack
         Real(kind = REAL32), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyRealDim2KindREAL32Stack(stack) result(answer)
         type(RealDim2KindREAL32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim2KindREAL32Stack
      subroutine pushRealDim2KindREAL64Stack(stack, value)
      ...
      function popRealDim2KindREAL64Stack(stack, value) result(isSuccess)
         type(RealDim2KindREAL64Stack), intent(inout):: stack
         Real(kind = REAL64), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyRealDim2KindREAL64Stack(stack) result(answer)
         type(RealDim2KindREAL64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim2KindREAL64Stack
      subroutine pushRealDim2KindREAL128Stack(stack, value)
      ...
      function popRealDim2KindREAL128Stack(stack, value) result(isSuccess)
         type(RealDim2KindREAL128Stack), intent(inout):: stack
         Real(kind = REAL128), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyRealDim2KindREAL128Stack(stack) result(answer)
         type(RealDim2KindREAL128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim2KindREAL128Stack
      subroutine pushRealDim3KindREAL32Stack(stack, value)
      ...
      function popRealDim3KindREAL32Stack(stack, value) result(isSuccess)
         type(RealDim3KindREAL32Stack), intent(inout):: stack
         Real(kind = REAL32), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyRealDim3KindREAL32Stack(stack) result(answer)
         type(RealDim3KindREAL32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim3KindREAL32Stack
      subroutine pushRealDim3KindREAL64Stack(stack, value)
      ...
      function popRealDim3KindREAL64Stack(stack, value) result(isSuccess)
         type(RealDim3KindREAL64Stack), intent(inout):: stack
         Real(kind = REAL64), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyRealDim3KindREAL64Stack(stack) result(answer)
         type(RealDim3KindREAL64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim3KindREAL64Stack
      subroutine pushRealDim3KindREAL128Stack(stack, value)
      ...
      function popRealDim3KindREAL128Stack(stack, value) result(isSuccess)
         type(RealDim3KindREAL128Stack), intent(inout):: stack
         Real(kind = REAL128), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyRealDim3KindREAL128Stack(stack) result(answer)
         type(RealDim3KindREAL128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim3KindREAL128Stack
      subroutine pushRealDim4KindREAL32Stack(stack, value)
      ...
      function popRealDim4KindREAL32Stack(stack, value) result(isSuccess)
         type(RealDim4KindREAL32Stack), intent(inout):: stack
         Real(kind = REAL32), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyRealDim4KindREAL32Stack(stack) result(answer)
         type(RealDim4KindREAL32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim4KindREAL32Stack
      subroutine pushRealDim4KindREAL64Stack(stack, value)
      ...
      function popRealDim4KindREAL64Stack(stack, value) result(isSuccess)
         type(RealDim4KindREAL64Stack), intent(inout):: stack
         Real(kind = REAL64), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyRealDim4KindREAL64Stack(stack) result(answer)
         type(RealDim4KindREAL64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim4KindREAL64Stack
      subroutine pushRealDim4KindREAL128Stack(stack, value)
      ...
      function popRealDim4KindREAL128Stack(stack, value) result(isSuccess)
         type(RealDim4KindREAL128Stack), intent(inout):: stack
         Real(kind = REAL128), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyRealDim4KindREAL128Stack(stack) result(answer)
         type(RealDim4KindREAL128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim4KindREAL128Stack
      subroutine pushRealDim5KindREAL32Stack(stack, value)
      ...
      function popRealDim5KindREAL32Stack(stack, value) result(isSuccess)
         type(RealDim5KindREAL32Stack), intent(inout):: stack
         Real(kind = REAL32), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyRealDim5KindREAL32Stack(stack) result(answer)
         type(RealDim5KindREAL32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim5KindREAL32Stack
      subroutine pushRealDim5KindREAL64Stack(stack, value)
      ...
      function popRealDim5KindREAL64Stack(stack, value) result(isSuccess)
         type(RealDim5KindREAL64Stack), intent(inout):: stack
         Real(kind = REAL64), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyRealDim5KindREAL64Stack(stack) result(answer)
         type(RealDim5KindREAL64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim5KindREAL64Stack
      subroutine pushRealDim5KindREAL128Stack(stack, value)
      ...
      function popRealDim5KindREAL128Stack(stack, value) result(isSuccess)
         type(RealDim5KindREAL128Stack), intent(inout):: stack
         Real(kind = REAL128), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyRealDim5KindREAL128Stack(stack) result(answer)
         type(RealDim5KindREAL128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim5KindREAL128Stack
      subroutine pushRealDim6KindREAL32Stack(stack, value)
      ...
      function popRealDim6KindREAL32Stack(stack, value) result(isSuccess)
         type(RealDim6KindREAL32Stack), intent(inout):: stack
         Real(kind = REAL32), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyRealDim6KindREAL32Stack(stack) result(answer)
         type(RealDim6KindREAL32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim6KindREAL32Stack
      subroutine pushRealDim6KindREAL64Stack(stack, value)
      ...
      function popRealDim6KindREAL64Stack(stack, value) result(isSuccess)
         type(RealDim6KindREAL64Stack), intent(inout):: stack
         Real(kind = REAL64), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyRealDim6KindREAL64Stack(stack) result(answer)
         type(RealDim6KindREAL64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim6KindREAL64Stack
      subroutine pushRealDim6KindREAL128Stack(stack, value)
      ...
      function popRealDim6KindREAL128Stack(stack, value) result(isSuccess)
         type(RealDim6KindREAL128Stack), intent(inout):: stack
         Real(kind = REAL128), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyRealDim6KindREAL128Stack(stack) result(answer)
         type(RealDim6KindREAL128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim6KindREAL128Stack
      subroutine pushRealDim7KindREAL32Stack(stack, value)
      ...
      function popRealDim7KindREAL32Stack(stack, value) result(isSuccess)
         type(RealDim7KindREAL32Stack), intent(inout):: stack
         Real(kind = REAL32), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyRealDim7KindREAL32Stack(stack) result(answer)
         type(RealDim7KindREAL32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim7KindREAL32Stack
      subroutine pushRealDim7KindREAL64Stack(stack, value)
      ...
      function popRealDim7KindREAL64Stack(stack, value) result(isSuccess)
         type(RealDim7KindREAL64Stack), intent(inout):: stack
         Real(kind = REAL64), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyRealDim7KindREAL64Stack(stack) result(answer)
         type(RealDim7KindREAL64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim7KindREAL64Stack
      subroutine pushRealDim7KindREAL128Stack(stack, value)
      ...
      function popRealDim7KindREAL128Stack(stack, value) result(isSuccess)
         type(RealDim7KindREAL128Stack), intent(inout):: stack
         Real(kind = REAL128), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyRealDim7KindREAL128Stack(stack) result(answer)
         type(RealDim7KindREAL128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyRealDim7KindREAL128Stack
      subroutine pushIntegerDim0KindINT8Stack(stack, value)
      ...
      function popIntegerDim0KindINT8Stack(stack, value) result(isSuccess)
         type(IntegerDim0KindINT8Stack), intent(inout):: stack
      ...
      function is_emptyIntegerDim0KindINT8Stack(stack) result(answer)
         type(IntegerDim0KindINT8Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim0KindINT8Stack
      subroutine pushIntegerDim0KindINT16Stack(stack, value)
      ...
      function popIntegerDim0KindINT16Stack(stack, value) result(isSuccess)
         type(IntegerDim0KindINT16Stack), intent(inout):: stack
      ...
      function is_emptyIntegerDim0KindINT16Stack(stack) result(answer)
         type(IntegerDim0KindINT16Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim0KindINT16Stack
      subroutine pushIntegerDim0KindINT32Stack(stack, value)
      ...
      function popIntegerDim0KindINT32Stack(stack, value) result(isSuccess)
         type(IntegerDim0KindINT32Stack), intent(inout):: stack
      ...
      function is_emptyIntegerDim0KindINT32Stack(stack) result(answer)
         type(IntegerDim0KindINT32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim0KindINT32Stack
      subroutine pushIntegerDim0KindINT64Stack(stack, value)
      ...
      function popIntegerDim0KindINT64Stack(stack, value) result(isSuccess)
         type(IntegerDim0KindINT64Stack), intent(inout):: stack
      ...
      function is_emptyIntegerDim0KindINT64Stack(stack) result(answer)
         type(IntegerDim0KindINT64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim0KindINT64Stack
      subroutine pushIntegerDim1KindINT8Stack(stack, value)
      ...
      function popIntegerDim1KindINT8Stack(stack, value) result(isSuccess)
         type(IntegerDim1KindINT8Stack), intent(inout):: stack
      ...
      function is_emptyIntegerDim1KindINT8Stack(stack) result(answer)
         type(IntegerDim1KindINT8Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim1KindINT8Stack
      subroutine pushIntegerDim1KindINT16Stack(stack, value)
      ...
      function popIntegerDim1KindINT16Stack(stack, value) result(isSuccess)
         type(IntegerDim1KindINT16Stack), intent(inout):: stack
      ...
      function is_emptyIntegerDim1KindINT16Stack(stack) result(answer)
         type(IntegerDim1KindINT16Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim1KindINT16Stack
      subroutine pushIntegerDim1KindINT32Stack(stack, value)
      ...
      function popIntegerDim1KindINT32Stack(stack, value) result(isSuccess)
         type(IntegerDim1KindINT32Stack), intent(inout):: stack
      ...
      function is_emptyIntegerDim1KindINT32Stack(stack) result(answer)
         type(IntegerDim1KindINT32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim1KindINT32Stack
      subroutine pushIntegerDim1KindINT64Stack(stack, value)
      ...
      function popIntegerDim1KindINT64Stack(stack, value) result(isSuccess)
         type(IntegerDim1KindINT64Stack), intent(inout):: stack
      ...
      function is_emptyIntegerDim1KindINT64Stack(stack) result(answer)
         type(IntegerDim1KindINT64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim1KindINT64Stack
      subroutine pushIntegerDim2KindINT8Stack(stack, value)
      ...
      function popIntegerDim2KindINT8Stack(stack, value) result(isSuccess)
         type(IntegerDim2KindINT8Stack), intent(inout):: stack
         Integer(kind = INT8), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim2KindINT8Stack(stack) result(answer)
         type(IntegerDim2KindINT8Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim2KindINT8Stack
      subroutine pushIntegerDim2KindINT16Stack(stack, value)
      ...
      function popIntegerDim2KindINT16Stack(stack, value) result(isSuccess)
         type(IntegerDim2KindINT16Stack), intent(inout):: stack
         Integer(kind = INT16), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim2KindINT16Stack(stack) result(answer)
         type(IntegerDim2KindINT16Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim2KindINT16Stack
      subroutine pushIntegerDim2KindINT32Stack(stack, value)
      ...
      function popIntegerDim2KindINT32Stack(stack, value) result(isSuccess)
         type(IntegerDim2KindINT32Stack), intent(inout):: stack
         Integer(kind = INT32), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim2KindINT32Stack(stack) result(answer)
         type(IntegerDim2KindINT32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim2KindINT32Stack
      subroutine pushIntegerDim2KindINT64Stack(stack, value)
      ...
      function popIntegerDim2KindINT64Stack(stack, value) result(isSuccess)
         type(IntegerDim2KindINT64Stack), intent(inout):: stack
         Integer(kind = INT64), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim2KindINT64Stack(stack) result(answer)
         type(IntegerDim2KindINT64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim2KindINT64Stack
      subroutine pushIntegerDim3KindINT8Stack(stack, value)
      ...
      function popIntegerDim3KindINT8Stack(stack, value) result(isSuccess)
         type(IntegerDim3KindINT8Stack), intent(inout):: stack
         Integer(kind = INT8), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim3KindINT8Stack(stack) result(answer)
         type(IntegerDim3KindINT8Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim3KindINT8Stack
      subroutine pushIntegerDim3KindINT16Stack(stack, value)
      ...
      function popIntegerDim3KindINT16Stack(stack, value) result(isSuccess)
         type(IntegerDim3KindINT16Stack), intent(inout):: stack
         Integer(kind = INT16), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim3KindINT16Stack(stack) result(answer)
         type(IntegerDim3KindINT16Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim3KindINT16Stack
      subroutine pushIntegerDim3KindINT32Stack(stack, value)
      ...
      function popIntegerDim3KindINT32Stack(stack, value) result(isSuccess)
         type(IntegerDim3KindINT32Stack), intent(inout):: stack
         Integer(kind = INT32), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim3KindINT32Stack(stack) result(answer)
         type(IntegerDim3KindINT32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim3KindINT32Stack
      subroutine pushIntegerDim3KindINT64Stack(stack, value)
      ...
      function popIntegerDim3KindINT64Stack(stack, value) result(isSuccess)
         type(IntegerDim3KindINT64Stack), intent(inout):: stack
         Integer(kind = INT64), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim3KindINT64Stack(stack) result(answer)
         type(IntegerDim3KindINT64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim3KindINT64Stack
      subroutine pushIntegerDim4KindINT8Stack(stack, value)
      ...
      function popIntegerDim4KindINT8Stack(stack, value) result(isSuccess)
         type(IntegerDim4KindINT8Stack), intent(inout):: stack
         Integer(kind = INT8), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim4KindINT8Stack(stack) result(answer)
         type(IntegerDim4KindINT8Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim4KindINT8Stack
      subroutine pushIntegerDim4KindINT16Stack(stack, value)
      ...
      function popIntegerDim4KindINT16Stack(stack, value) result(isSuccess)
         type(IntegerDim4KindINT16Stack), intent(inout):: stack
         Integer(kind = INT16), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim4KindINT16Stack(stack) result(answer)
         type(IntegerDim4KindINT16Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim4KindINT16Stack
      subroutine pushIntegerDim4KindINT32Stack(stack, value)
      ...
      function popIntegerDim4KindINT32Stack(stack, value) result(isSuccess)
         type(IntegerDim4KindINT32Stack), intent(inout):: stack
         Integer(kind = INT32), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim4KindINT32Stack(stack) result(answer)
         type(IntegerDim4KindINT32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim4KindINT32Stack
      subroutine pushIntegerDim4KindINT64Stack(stack, value)
      ...
      function popIntegerDim4KindINT64Stack(stack, value) result(isSuccess)
         type(IntegerDim4KindINT64Stack), intent(inout):: stack
         Integer(kind = INT64), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim4KindINT64Stack(stack) result(answer)
         type(IntegerDim4KindINT64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim4KindINT64Stack
      subroutine pushIntegerDim5KindINT8Stack(stack, value)
      ...
      function popIntegerDim5KindINT8Stack(stack, value) result(isSuccess)
         type(IntegerDim5KindINT8Stack), intent(inout):: stack
         Integer(kind = INT8), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim5KindINT8Stack(stack) result(answer)
         type(IntegerDim5KindINT8Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim5KindINT8Stack
      subroutine pushIntegerDim5KindINT16Stack(stack, value)
      ...
      function popIntegerDim5KindINT16Stack(stack, value) result(isSuccess)
         type(IntegerDim5KindINT16Stack), intent(inout):: stack
         Integer(kind = INT16), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim5KindINT16Stack(stack) result(answer)
         type(IntegerDim5KindINT16Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim5KindINT16Stack
      subroutine pushIntegerDim5KindINT32Stack(stack, value)
      ...
      function popIntegerDim5KindINT32Stack(stack, value) result(isSuccess)
         type(IntegerDim5KindINT32Stack), intent(inout):: stack
         Integer(kind = INT32), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim5KindINT32Stack(stack) result(answer)
         type(IntegerDim5KindINT32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim5KindINT32Stack
      subroutine pushIntegerDim5KindINT64Stack(stack, value)
      ...
      function popIntegerDim5KindINT64Stack(stack, value) result(isSuccess)
         type(IntegerDim5KindINT64Stack), intent(inout):: stack
         Integer(kind = INT64), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim5KindINT64Stack(stack) result(answer)
         type(IntegerDim5KindINT64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim5KindINT64Stack
      subroutine pushIntegerDim6KindINT8Stack(stack, value)
      ...
      function popIntegerDim6KindINT8Stack(stack, value) result(isSuccess)
         type(IntegerDim6KindINT8Stack), intent(inout):: stack
         Integer(kind = INT8), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim6KindINT8Stack(stack) result(answer)
         type(IntegerDim6KindINT8Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim6KindINT8Stack
      subroutine pushIntegerDim6KindINT16Stack(stack, value)
      ...
      function popIntegerDim6KindINT16Stack(stack, value) result(isSuccess)
         type(IntegerDim6KindINT16Stack), intent(inout):: stack
         Integer(kind = INT16), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim6KindINT16Stack(stack) result(answer)
         type(IntegerDim6KindINT16Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim6KindINT16Stack
      subroutine pushIntegerDim6KindINT32Stack(stack, value)
      ...
      function popIntegerDim6KindINT32Stack(stack, value) result(isSuccess)
         type(IntegerDim6KindINT32Stack), intent(inout):: stack
         Integer(kind = INT32), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim6KindINT32Stack(stack) result(answer)
         type(IntegerDim6KindINT32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim6KindINT32Stack
      subroutine pushIntegerDim6KindINT64Stack(stack, value)
      ...
      function popIntegerDim6KindINT64Stack(stack, value) result(isSuccess)
         type(IntegerDim6KindINT64Stack), intent(inout):: stack
         Integer(kind = INT64), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim6KindINT64Stack(stack) result(answer)
         type(IntegerDim6KindINT64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim6KindINT64Stack
      subroutine pushIntegerDim7KindINT8Stack(stack, value)
      ...
      function popIntegerDim7KindINT8Stack(stack, value) result(isSuccess)
         type(IntegerDim7KindINT8Stack), intent(inout):: stack
         Integer(kind = INT8), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim7KindINT8Stack(stack) result(answer)
         type(IntegerDim7KindINT8Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim7KindINT8Stack
      subroutine pushIntegerDim7KindINT16Stack(stack, value)
      ...
      function popIntegerDim7KindINT16Stack(stack, value) result(isSuccess)
         type(IntegerDim7KindINT16Stack), intent(inout):: stack
         Integer(kind = INT16), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim7KindINT16Stack(stack) result(answer)
         type(IntegerDim7KindINT16Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim7KindINT16Stack
      subroutine pushIntegerDim7KindINT32Stack(stack, value)
      ...
      function popIntegerDim7KindINT32Stack(stack, value) result(isSuccess)
         type(IntegerDim7KindINT32Stack), intent(inout):: stack
         Integer(kind = INT32), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim7KindINT32Stack(stack) result(answer)
         type(IntegerDim7KindINT32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim7KindINT32Stack
      subroutine pushIntegerDim7KindINT64Stack(stack, value)
      ...
      function popIntegerDim7KindINT64Stack(stack, value) result(isSuccess)
         type(IntegerDim7KindINT64Stack), intent(inout):: stack
         Integer(kind = INT64), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyIntegerDim7KindINT64Stack(stack) result(answer)
         type(IntegerDim7KindINT64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyIntegerDim7KindINT64Stack
      subroutine pushLogicalDim0Stack(stack, value)
      ...
      function popLogicalDim0Stack(stack, value) result(isSuccess)
         type(LogicalDim0Stack), intent(inout):: stack
      ...
      function is_emptyLogicalDim0Stack(stack) result(answer)
         type(LogicalDim0Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyLogicalDim0Stack
      subroutine pushLogicalDim1Stack(stack, value)
      ...
      function popLogicalDim1Stack(stack, value) result(isSuccess)
         type(LogicalDim1Stack), intent(inout):: stack
      ...
      function is_emptyLogicalDim1Stack(stack) result(answer)
         type(LogicalDim1Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyLogicalDim1Stack
      subroutine pushLogicalDim2Stack(stack, value)
      ...
      function popLogicalDim2Stack(stack, value) result(isSuccess)
         type(LogicalDim2Stack), intent(inout):: stack
         Logical, dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyLogicalDim2Stack(stack) result(answer)
         type(LogicalDim2Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyLogicalDim2Stack
      subroutine pushLogicalDim3Stack(stack, value)
      ...
      function popLogicalDim3Stack(stack, value) result(isSuccess)
         type(LogicalDim3Stack), intent(inout):: stack
         Logical, dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyLogicalDim3Stack(stack) result(answer)
         type(LogicalDim3Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyLogicalDim3Stack
      subroutine pushLogicalDim4Stack(stack, value)
      ...
      function popLogicalDim4Stack(stack, value) result(isSuccess)
         type(LogicalDim4Stack), intent(inout):: stack
         Logical, dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyLogicalDim4Stack(stack) result(answer)
         type(LogicalDim4Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyLogicalDim4Stack
      subroutine pushLogicalDim5Stack(stack, value)
      ...
      function popLogicalDim5Stack(stack, value) result(isSuccess)
         type(LogicalDim5Stack), intent(inout):: stack
         Logical, dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyLogicalDim5Stack(stack) result(answer)
         type(LogicalDim5Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyLogicalDim5Stack
      subroutine pushLogicalDim6Stack(stack, value)
      ...
      function popLogicalDim6Stack(stack, value) result(isSuccess)
         type(LogicalDim6Stack), intent(inout):: stack
         Logical, dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyLogicalDim6Stack(stack) result(answer)
         type(LogicalDim6Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyLogicalDim6Stack
      subroutine pushLogicalDim7Stack(stack, value)
      ...
      function popLogicalDim7Stack(stack, value) result(isSuccess)
         type(LogicalDim7Stack), intent(inout):: stack
         Logical, dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyLogicalDim7Stack(stack) result(answer)
         type(LogicalDim7Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyLogicalDim7Stack
      subroutine pushComplexDim0KindREAL32Stack(stack, value)
      ...
      function popComplexDim0KindREAL32Stack(stack, value) result(isSuccess)
         type(ComplexDim0KindREAL32Stack), intent(inout):: stack
      ...
      function is_emptyComplexDim0KindREAL32Stack(stack) result(answer)
         type(ComplexDim0KindREAL32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim0KindREAL32Stack
      subroutine pushComplexDim0KindREAL64Stack(stack, value)
      ...
      function popComplexDim0KindREAL64Stack(stack, value) result(isSuccess)
         type(ComplexDim0KindREAL64Stack), intent(inout):: stack
      ...
      function is_emptyComplexDim0KindREAL64Stack(stack) result(answer)
         type(ComplexDim0KindREAL64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim0KindREAL64Stack
      subroutine pushComplexDim0KindREAL128Stack(stack, value)
      ...
      function popComplexDim0KindREAL128Stack(stack, value) result(isSuccess)
         type(ComplexDim0KindREAL128Stack), intent(inout):: stack
      ...
      function is_emptyComplexDim0KindREAL128Stack(stack) result(answer)
         type(ComplexDim0KindREAL128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim0KindREAL128Stack
      subroutine pushComplexDim1KindREAL32Stack(stack, value)
      ...
      function popComplexDim1KindREAL32Stack(stack, value) result(isSuccess)
         type(ComplexDim1KindREAL32Stack), intent(inout):: stack
      ...
      function is_emptyComplexDim1KindREAL32Stack(stack) result(answer)
         type(ComplexDim1KindREAL32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim1KindREAL32Stack
      subroutine pushComplexDim1KindREAL64Stack(stack, value)
      ...
      function popComplexDim1KindREAL64Stack(stack, value) result(isSuccess)
         type(ComplexDim1KindREAL64Stack), intent(inout):: stack
      ...
      function is_emptyComplexDim1KindREAL64Stack(stack) result(answer)
         type(ComplexDim1KindREAL64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim1KindREAL64Stack
      subroutine pushComplexDim1KindREAL128Stack(stack, value)
      ...
      function popComplexDim1KindREAL128Stack(stack, value) result(isSuccess)
         type(ComplexDim1KindREAL128Stack), intent(inout):: stack
      ...
      function is_emptyComplexDim1KindREAL128Stack(stack) result(answer)
         type(ComplexDim1KindREAL128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim1KindREAL128Stack
      subroutine pushComplexDim2KindREAL32Stack(stack, value)
      ...
      function popComplexDim2KindREAL32Stack(stack, value) result(isSuccess)
         type(ComplexDim2KindREAL32Stack), intent(inout):: stack
         Complex(kind = REAL32), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyComplexDim2KindREAL32Stack(stack) result(answer)
         type(ComplexDim2KindREAL32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim2KindREAL32Stack
      subroutine pushComplexDim2KindREAL64Stack(stack, value)
      ...
      function popComplexDim2KindREAL64Stack(stack, value) result(isSuccess)
         type(ComplexDim2KindREAL64Stack), intent(inout):: stack
         Complex(kind = REAL64), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyComplexDim2KindREAL64Stack(stack) result(answer)
         type(ComplexDim2KindREAL64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim2KindREAL64Stack
      subroutine pushComplexDim2KindREAL128Stack(stack, value)
      ...
      function popComplexDim2KindREAL128Stack(stack, value) result(isSuccess)
         type(ComplexDim2KindREAL128Stack), intent(inout):: stack
         Complex(kind = REAL128), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyComplexDim2KindREAL128Stack(stack) result(answer)
         type(ComplexDim2KindREAL128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim2KindREAL128Stack
      subroutine pushComplexDim3KindREAL32Stack(stack, value)
      ...
      function popComplexDim3KindREAL32Stack(stack, value) result(isSuccess)
         type(ComplexDim3KindREAL32Stack), intent(inout):: stack
         Complex(kind = REAL32), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyComplexDim3KindREAL32Stack(stack) result(answer)
         type(ComplexDim3KindREAL32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim3KindREAL32Stack
      subroutine pushComplexDim3KindREAL64Stack(stack, value)
      ...
      function popComplexDim3KindREAL64Stack(stack, value) result(isSuccess)
         type(ComplexDim3KindREAL64Stack), intent(inout):: stack
         Complex(kind = REAL64), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyComplexDim3KindREAL64Stack(stack) result(answer)
         type(ComplexDim3KindREAL64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim3KindREAL64Stack
      subroutine pushComplexDim3KindREAL128Stack(stack, value)
      ...
      function popComplexDim3KindREAL128Stack(stack, value) result(isSuccess)
         type(ComplexDim3KindREAL128Stack), intent(inout):: stack
         Complex(kind = REAL128), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyComplexDim3KindREAL128Stack(stack) result(answer)
         type(ComplexDim3KindREAL128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim3KindREAL128Stack
      subroutine pushComplexDim4KindREAL32Stack(stack, value)
      ...
      function popComplexDim4KindREAL32Stack(stack, value) result(isSuccess)
         type(ComplexDim4KindREAL32Stack), intent(inout):: stack
         Complex(kind = REAL32), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyComplexDim4KindREAL32Stack(stack) result(answer)
         type(ComplexDim4KindREAL32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim4KindREAL32Stack
      subroutine pushComplexDim4KindREAL64Stack(stack, value)
      ...
      function popComplexDim4KindREAL64Stack(stack, value) result(isSuccess)
         type(ComplexDim4KindREAL64Stack), intent(inout):: stack
         Complex(kind = REAL64), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyComplexDim4KindREAL64Stack(stack) result(answer)
         type(ComplexDim4KindREAL64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim4KindREAL64Stack
      subroutine pushComplexDim4KindREAL128Stack(stack, value)
      ...
      function popComplexDim4KindREAL128Stack(stack, value) result(isSuccess)
         type(ComplexDim4KindREAL128Stack), intent(inout):: stack
         Complex(kind = REAL128), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyComplexDim4KindREAL128Stack(stack) result(answer)
         type(ComplexDim4KindREAL128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim4KindREAL128Stack
      subroutine pushComplexDim5KindREAL32Stack(stack, value)
      ...
      function popComplexDim5KindREAL32Stack(stack, value) result(isSuccess)
         type(ComplexDim5KindREAL32Stack), intent(inout):: stack
         Complex(kind = REAL32), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyComplexDim5KindREAL32Stack(stack) result(answer)
         type(ComplexDim5KindREAL32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim5KindREAL32Stack
      subroutine pushComplexDim5KindREAL64Stack(stack, value)
      ...
      function popComplexDim5KindREAL64Stack(stack, value) result(isSuccess)
         type(ComplexDim5KindREAL64Stack), intent(inout):: stack
         Complex(kind = REAL64), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyComplexDim5KindREAL64Stack(stack) result(answer)
         type(ComplexDim5KindREAL64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim5KindREAL64Stack
      subroutine pushComplexDim5KindREAL128Stack(stack, value)
      ...
      function popComplexDim5KindREAL128Stack(stack, value) result(isSuccess)
         type(ComplexDim5KindREAL128Stack), intent(inout):: stack
         Complex(kind = REAL128), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyComplexDim5KindREAL128Stack(stack) result(answer)
         type(ComplexDim5KindREAL128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim5KindREAL128Stack
      subroutine pushComplexDim6KindREAL32Stack(stack, value)
      ...
      function popComplexDim6KindREAL32Stack(stack, value) result(isSuccess)
         type(ComplexDim6KindREAL32Stack), intent(inout):: stack
         Complex(kind = REAL32), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyComplexDim6KindREAL32Stack(stack) result(answer)
         type(ComplexDim6KindREAL32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim6KindREAL32Stack
      subroutine pushComplexDim6KindREAL64Stack(stack, value)
      ...
      function popComplexDim6KindREAL64Stack(stack, value) result(isSuccess)
         type(ComplexDim6KindREAL64Stack), intent(inout):: stack
         Complex(kind = REAL64), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyComplexDim6KindREAL64Stack(stack) result(answer)
         type(ComplexDim6KindREAL64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim6KindREAL64Stack
      subroutine pushComplexDim6KindREAL128Stack(stack, value)
      ...
      function popComplexDim6KindREAL128Stack(stack, value) result(isSuccess)
         type(ComplexDim6KindREAL128Stack), intent(inout):: stack
         Complex(kind = REAL128), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyComplexDim6KindREAL128Stack(stack) result(answer)
         type(ComplexDim6KindREAL128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim6KindREAL128Stack
      subroutine pushComplexDim7KindREAL32Stack(stack, value)
      ...
      function popComplexDim7KindREAL32Stack(stack, value) result(isSuccess)
         type(ComplexDim7KindREAL32Stack), intent(inout):: stack
         Complex(kind = REAL32), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyComplexDim7KindREAL32Stack(stack) result(answer)
         type(ComplexDim7KindREAL32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim7KindREAL32Stack
      subroutine pushComplexDim7KindREAL64Stack(stack, value)
      ...
      function popComplexDim7KindREAL64Stack(stack, value) result(isSuccess)
         type(ComplexDim7KindREAL64Stack), intent(inout):: stack
         Complex(kind = REAL64), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyComplexDim7KindREAL64Stack(stack) result(answer)
         type(ComplexDim7KindREAL64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim7KindREAL64Stack
      subroutine pushComplexDim7KindREAL128Stack(stack, value)
      ...
      function popComplexDim7KindREAL128Stack(stack, value) result(isSuccess)
         type(ComplexDim7KindREAL128Stack), intent(inout):: stack
         Complex(kind = REAL128), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyComplexDim7KindREAL128Stack(stack) result(answer)
         type(ComplexDim7KindREAL128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyComplexDim7KindREAL128Stack
      subroutine pushCharacterDim0Len1Stack(stack, value)
      ...
      function popCharacterDim0Len1Stack(stack, value) result(isSuccess)
         type(CharacterDim0Len1Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim0Len1Stack(stack) result(answer)
         type(CharacterDim0Len1Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim0Len1Stack
      subroutine pushCharacterDim0Len2Stack(stack, value)
      ...
      function popCharacterDim0Len2Stack(stack, value) result(isSuccess)
         type(CharacterDim0Len2Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim0Len2Stack(stack) result(answer)
         type(CharacterDim0Len2Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim0Len2Stack
      subroutine pushCharacterDim0Len4Stack(stack, value)
      ...
      function popCharacterDim0Len4Stack(stack, value) result(isSuccess)
         type(CharacterDim0Len4Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim0Len4Stack(stack) result(answer)
         type(CharacterDim0Len4Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim0Len4Stack
      subroutine pushCharacterDim0Len8Stack(stack, value)
      ...
      function popCharacterDim0Len8Stack(stack, value) result(isSuccess)
         type(CharacterDim0Len8Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim0Len8Stack(stack) result(answer)
         type(CharacterDim0Len8Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim0Len8Stack
      subroutine pushCharacterDim0Len16Stack(stack, value)
      ...
      function popCharacterDim0Len16Stack(stack, value) result(isSuccess)
         type(CharacterDim0Len16Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim0Len16Stack(stack) result(answer)
         type(CharacterDim0Len16Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim0Len16Stack
      subroutine pushCharacterDim0Len32Stack(stack, value)
      ...
      function popCharacterDim0Len32Stack(stack, value) result(isSuccess)
         type(CharacterDim0Len32Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim0Len32Stack(stack) result(answer)
         type(CharacterDim0Len32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim0Len32Stack
      subroutine pushCharacterDim0Len64Stack(stack, value)
      ...
      function popCharacterDim0Len64Stack(stack, value) result(isSuccess)
         type(CharacterDim0Len64Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim0Len64Stack(stack) result(answer)
         type(CharacterDim0Len64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim0Len64Stack
      subroutine pushCharacterDim0Len128Stack(stack, value)
      ...
      function popCharacterDim0Len128Stack(stack, value) result(isSuccess)
         type(CharacterDim0Len128Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim0Len128Stack(stack) result(answer)
         type(CharacterDim0Len128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim0Len128Stack
      subroutine pushCharacterDim0Len256Stack(stack, value)
      ...
      function popCharacterDim0Len256Stack(stack, value) result(isSuccess)
         type(CharacterDim0Len256Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim0Len256Stack(stack) result(answer)
         type(CharacterDim0Len256Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim0Len256Stack
      subroutine pushCharacterDim0Len512Stack(stack, value)
      ...
      function popCharacterDim0Len512Stack(stack, value) result(isSuccess)
         type(CharacterDim0Len512Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim0Len512Stack(stack) result(answer)
         type(CharacterDim0Len512Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim0Len512Stack
      subroutine pushCharacterDim0Len1024Stack(stack, value)
      ...
      function popCharacterDim0Len1024Stack(stack, value) result(isSuccess)
         type(CharacterDim0Len1024Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim0Len1024Stack(stack) result(answer)
         type(CharacterDim0Len1024Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim0Len1024Stack
      subroutine pushCharacterDim1Len1Stack(stack, value)
      ...
      function popCharacterDim1Len1Stack(stack, value) result(isSuccess)
         type(CharacterDim1Len1Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim1Len1Stack(stack) result(answer)
         type(CharacterDim1Len1Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim1Len1Stack
      subroutine pushCharacterDim1Len2Stack(stack, value)
      ...
      function popCharacterDim1Len2Stack(stack, value) result(isSuccess)
         type(CharacterDim1Len2Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim1Len2Stack(stack) result(answer)
         type(CharacterDim1Len2Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim1Len2Stack
      subroutine pushCharacterDim1Len4Stack(stack, value)
      ...
      function popCharacterDim1Len4Stack(stack, value) result(isSuccess)
         type(CharacterDim1Len4Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim1Len4Stack(stack) result(answer)
         type(CharacterDim1Len4Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim1Len4Stack
      subroutine pushCharacterDim1Len8Stack(stack, value)
      ...
      function popCharacterDim1Len8Stack(stack, value) result(isSuccess)
         type(CharacterDim1Len8Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim1Len8Stack(stack) result(answer)
         type(CharacterDim1Len8Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim1Len8Stack
      subroutine pushCharacterDim1Len16Stack(stack, value)
      ...
      function popCharacterDim1Len16Stack(stack, value) result(isSuccess)
         type(CharacterDim1Len16Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim1Len16Stack(stack) result(answer)
         type(CharacterDim1Len16Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim1Len16Stack
      subroutine pushCharacterDim1Len32Stack(stack, value)
      ...
      function popCharacterDim1Len32Stack(stack, value) result(isSuccess)
         type(CharacterDim1Len32Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim1Len32Stack(stack) result(answer)
         type(CharacterDim1Len32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim1Len32Stack
      subroutine pushCharacterDim1Len64Stack(stack, value)
      ...
      function popCharacterDim1Len64Stack(stack, value) result(isSuccess)
         type(CharacterDim1Len64Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim1Len64Stack(stack) result(answer)
         type(CharacterDim1Len64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim1Len64Stack
      subroutine pushCharacterDim1Len128Stack(stack, value)
      ...
      function popCharacterDim1Len128Stack(stack, value) result(isSuccess)
         type(CharacterDim1Len128Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim1Len128Stack(stack) result(answer)
         type(CharacterDim1Len128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim1Len128Stack
      subroutine pushCharacterDim1Len256Stack(stack, value)
      ...
      function popCharacterDim1Len256Stack(stack, value) result(isSuccess)
         type(CharacterDim1Len256Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim1Len256Stack(stack) result(answer)
         type(CharacterDim1Len256Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim1Len256Stack
      subroutine pushCharacterDim1Len512Stack(stack, value)
      ...
      function popCharacterDim1Len512Stack(stack, value) result(isSuccess)
         type(CharacterDim1Len512Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim1Len512Stack(stack) result(answer)
         type(CharacterDim1Len512Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim1Len512Stack
      subroutine pushCharacterDim1Len1024Stack(stack, value)
      ...
      function popCharacterDim1Len1024Stack(stack, value) result(isSuccess)
         type(CharacterDim1Len1024Stack), intent(inout):: stack
      ...
      function is_emptyCharacterDim1Len1024Stack(stack) result(answer)
         type(CharacterDim1Len1024Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim1Len1024Stack
      subroutine pushCharacterDim2Len1Stack(stack, value)
      ...
      function popCharacterDim2Len1Stack(stack, value) result(isSuccess)
         type(CharacterDim2Len1Stack), intent(inout):: stack
         Character(len = 1), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim2Len1Stack(stack) result(answer)
         type(CharacterDim2Len1Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim2Len1Stack
      subroutine pushCharacterDim2Len2Stack(stack, value)
      ...
      function popCharacterDim2Len2Stack(stack, value) result(isSuccess)
         type(CharacterDim2Len2Stack), intent(inout):: stack
         Character(len = 2), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim2Len2Stack(stack) result(answer)
         type(CharacterDim2Len2Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim2Len2Stack
      subroutine pushCharacterDim2Len4Stack(stack, value)
      ...
      function popCharacterDim2Len4Stack(stack, value) result(isSuccess)
         type(CharacterDim2Len4Stack), intent(inout):: stack
         Character(len = 4), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim2Len4Stack(stack) result(answer)
         type(CharacterDim2Len4Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim2Len4Stack
      subroutine pushCharacterDim2Len8Stack(stack, value)
      ...
      function popCharacterDim2Len8Stack(stack, value) result(isSuccess)
         type(CharacterDim2Len8Stack), intent(inout):: stack
         Character(len = 8), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim2Len8Stack(stack) result(answer)
         type(CharacterDim2Len8Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim2Len8Stack
      subroutine pushCharacterDim2Len16Stack(stack, value)
      ...
      function popCharacterDim2Len16Stack(stack, value) result(isSuccess)
         type(CharacterDim2Len16Stack), intent(inout):: stack
         Character(len = 16), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim2Len16Stack(stack) result(answer)
         type(CharacterDim2Len16Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim2Len16Stack
      subroutine pushCharacterDim2Len32Stack(stack, value)
      ...
      function popCharacterDim2Len32Stack(stack, value) result(isSuccess)
         type(CharacterDim2Len32Stack), intent(inout):: stack
         Character(len = 32), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim2Len32Stack(stack) result(answer)
         type(CharacterDim2Len32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim2Len32Stack
      subroutine pushCharacterDim2Len64Stack(stack, value)
      ...
      function popCharacterDim2Len64Stack(stack, value) result(isSuccess)
         type(CharacterDim2Len64Stack), intent(inout):: stack
         Character(len = 64), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim2Len64Stack(stack) result(answer)
         type(CharacterDim2Len64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim2Len64Stack
      subroutine pushCharacterDim2Len128Stack(stack, value)
      ...
      function popCharacterDim2Len128Stack(stack, value) result(isSuccess)
         type(CharacterDim2Len128Stack), intent(inout):: stack
         Character(len = 128), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim2Len128Stack(stack) result(answer)
         type(CharacterDim2Len128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim2Len128Stack
      subroutine pushCharacterDim2Len256Stack(stack, value)
      ...
      function popCharacterDim2Len256Stack(stack, value) result(isSuccess)
         type(CharacterDim2Len256Stack), intent(inout):: stack
         Character(len = 256), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim2Len256Stack(stack) result(answer)
         type(CharacterDim2Len256Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim2Len256Stack
      subroutine pushCharacterDim2Len512Stack(stack, value)
      ...
      function popCharacterDim2Len512Stack(stack, value) result(isSuccess)
         type(CharacterDim2Len512Stack), intent(inout):: stack
         Character(len = 512), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim2Len512Stack(stack) result(answer)
         type(CharacterDim2Len512Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim2Len512Stack
      subroutine pushCharacterDim2Len1024Stack(stack, value)
      ...
      function popCharacterDim2Len1024Stack(stack, value) result(isSuccess)
         type(CharacterDim2Len1024Stack), intent(inout):: stack
         Character(len = 1024), dimension(:, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim2Len1024Stack(stack) result(answer)
         type(CharacterDim2Len1024Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim2Len1024Stack
      subroutine pushCharacterDim3Len1Stack(stack, value)
      ...
      function popCharacterDim3Len1Stack(stack, value) result(isSuccess)
         type(CharacterDim3Len1Stack), intent(inout):: stack
         Character(len = 1), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim3Len1Stack(stack) result(answer)
         type(CharacterDim3Len1Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim3Len1Stack
      subroutine pushCharacterDim3Len2Stack(stack, value)
      ...
      function popCharacterDim3Len2Stack(stack, value) result(isSuccess)
         type(CharacterDim3Len2Stack), intent(inout):: stack
         Character(len = 2), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim3Len2Stack(stack) result(answer)
         type(CharacterDim3Len2Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim3Len2Stack
      subroutine pushCharacterDim3Len4Stack(stack, value)
      ...
      function popCharacterDim3Len4Stack(stack, value) result(isSuccess)
         type(CharacterDim3Len4Stack), intent(inout):: stack
         Character(len = 4), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim3Len4Stack(stack) result(answer)
         type(CharacterDim3Len4Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim3Len4Stack
      subroutine pushCharacterDim3Len8Stack(stack, value)
      ...
      function popCharacterDim3Len8Stack(stack, value) result(isSuccess)
         type(CharacterDim3Len8Stack), intent(inout):: stack
         Character(len = 8), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim3Len8Stack(stack) result(answer)
         type(CharacterDim3Len8Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim3Len8Stack
      subroutine pushCharacterDim3Len16Stack(stack, value)
      ...
      function popCharacterDim3Len16Stack(stack, value) result(isSuccess)
         type(CharacterDim3Len16Stack), intent(inout):: stack
         Character(len = 16), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim3Len16Stack(stack) result(answer)
         type(CharacterDim3Len16Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim3Len16Stack
      subroutine pushCharacterDim3Len32Stack(stack, value)
      ...
      function popCharacterDim3Len32Stack(stack, value) result(isSuccess)
         type(CharacterDim3Len32Stack), intent(inout):: stack
         Character(len = 32), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim3Len32Stack(stack) result(answer)
         type(CharacterDim3Len32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim3Len32Stack
      subroutine pushCharacterDim3Len64Stack(stack, value)
      ...
      function popCharacterDim3Len64Stack(stack, value) result(isSuccess)
         type(CharacterDim3Len64Stack), intent(inout):: stack
         Character(len = 64), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim3Len64Stack(stack) result(answer)
         type(CharacterDim3Len64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim3Len64Stack
      subroutine pushCharacterDim3Len128Stack(stack, value)
      ...
      function popCharacterDim3Len128Stack(stack, value) result(isSuccess)
         type(CharacterDim3Len128Stack), intent(inout):: stack
         Character(len = 128), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim3Len128Stack(stack) result(answer)
         type(CharacterDim3Len128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim3Len128Stack
      subroutine pushCharacterDim3Len256Stack(stack, value)
      ...
      function popCharacterDim3Len256Stack(stack, value) result(isSuccess)
         type(CharacterDim3Len256Stack), intent(inout):: stack
         Character(len = 256), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim3Len256Stack(stack) result(answer)
         type(CharacterDim3Len256Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim3Len256Stack
      subroutine pushCharacterDim3Len512Stack(stack, value)
      ...
      function popCharacterDim3Len512Stack(stack, value) result(isSuccess)
         type(CharacterDim3Len512Stack), intent(inout):: stack
         Character(len = 512), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim3Len512Stack(stack) result(answer)
         type(CharacterDim3Len512Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim3Len512Stack
      subroutine pushCharacterDim3Len1024Stack(stack, value)
      ...
      function popCharacterDim3Len1024Stack(stack, value) result(isSuccess)
         type(CharacterDim3Len1024Stack), intent(inout):: stack
         Character(len = 1024), dimension(:, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim3Len1024Stack(stack) result(answer)
         type(CharacterDim3Len1024Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim3Len1024Stack
      subroutine pushCharacterDim4Len1Stack(stack, value)
      ...
      function popCharacterDim4Len1Stack(stack, value) result(isSuccess)
         type(CharacterDim4Len1Stack), intent(inout):: stack
         Character(len = 1), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim4Len1Stack(stack) result(answer)
         type(CharacterDim4Len1Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim4Len1Stack
      subroutine pushCharacterDim4Len2Stack(stack, value)
      ...
      function popCharacterDim4Len2Stack(stack, value) result(isSuccess)
         type(CharacterDim4Len2Stack), intent(inout):: stack
         Character(len = 2), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim4Len2Stack(stack) result(answer)
         type(CharacterDim4Len2Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim4Len2Stack
      subroutine pushCharacterDim4Len4Stack(stack, value)
      ...
      function popCharacterDim4Len4Stack(stack, value) result(isSuccess)
         type(CharacterDim4Len4Stack), intent(inout):: stack
         Character(len = 4), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim4Len4Stack(stack) result(answer)
         type(CharacterDim4Len4Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim4Len4Stack
      subroutine pushCharacterDim4Len8Stack(stack, value)
      ...
      function popCharacterDim4Len8Stack(stack, value) result(isSuccess)
         type(CharacterDim4Len8Stack), intent(inout):: stack
         Character(len = 8), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim4Len8Stack(stack) result(answer)
         type(CharacterDim4Len8Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim4Len8Stack
      subroutine pushCharacterDim4Len16Stack(stack, value)
      ...
      function popCharacterDim4Len16Stack(stack, value) result(isSuccess)
         type(CharacterDim4Len16Stack), intent(inout):: stack
         Character(len = 16), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim4Len16Stack(stack) result(answer)
         type(CharacterDim4Len16Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim4Len16Stack
      subroutine pushCharacterDim4Len32Stack(stack, value)
      ...
      function popCharacterDim4Len32Stack(stack, value) result(isSuccess)
         type(CharacterDim4Len32Stack), intent(inout):: stack
         Character(len = 32), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim4Len32Stack(stack) result(answer)
         type(CharacterDim4Len32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim4Len32Stack
      subroutine pushCharacterDim4Len64Stack(stack, value)
      ...
      function popCharacterDim4Len64Stack(stack, value) result(isSuccess)
         type(CharacterDim4Len64Stack), intent(inout):: stack
         Character(len = 64), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim4Len64Stack(stack) result(answer)
         type(CharacterDim4Len64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim4Len64Stack
      subroutine pushCharacterDim4Len128Stack(stack, value)
      ...
      function popCharacterDim4Len128Stack(stack, value) result(isSuccess)
         type(CharacterDim4Len128Stack), intent(inout):: stack
         Character(len = 128), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim4Len128Stack(stack) result(answer)
         type(CharacterDim4Len128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim4Len128Stack
      subroutine pushCharacterDim4Len256Stack(stack, value)
      ...
      function popCharacterDim4Len256Stack(stack, value) result(isSuccess)
         type(CharacterDim4Len256Stack), intent(inout):: stack
         Character(len = 256), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim4Len256Stack(stack) result(answer)
         type(CharacterDim4Len256Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim4Len256Stack
      subroutine pushCharacterDim4Len512Stack(stack, value)
      ...
      function popCharacterDim4Len512Stack(stack, value) result(isSuccess)
         type(CharacterDim4Len512Stack), intent(inout):: stack
         Character(len = 512), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim4Len512Stack(stack) result(answer)
         type(CharacterDim4Len512Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim4Len512Stack
      subroutine pushCharacterDim4Len1024Stack(stack, value)
      ...
      function popCharacterDim4Len1024Stack(stack, value) result(isSuccess)
         type(CharacterDim4Len1024Stack), intent(inout):: stack
         Character(len = 1024), dimension(:, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim4Len1024Stack(stack) result(answer)
         type(CharacterDim4Len1024Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim4Len1024Stack
      subroutine pushCharacterDim5Len1Stack(stack, value)
      ...
      function popCharacterDim5Len1Stack(stack, value) result(isSuccess)
         type(CharacterDim5Len1Stack), intent(inout):: stack
         Character(len = 1), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim5Len1Stack(stack) result(answer)
         type(CharacterDim5Len1Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim5Len1Stack
      subroutine pushCharacterDim5Len2Stack(stack, value)
      ...
      function popCharacterDim5Len2Stack(stack, value) result(isSuccess)
         type(CharacterDim5Len2Stack), intent(inout):: stack
         Character(len = 2), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim5Len2Stack(stack) result(answer)
         type(CharacterDim5Len2Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim5Len2Stack
      subroutine pushCharacterDim5Len4Stack(stack, value)
      ...
      function popCharacterDim5Len4Stack(stack, value) result(isSuccess)
         type(CharacterDim5Len4Stack), intent(inout):: stack
         Character(len = 4), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim5Len4Stack(stack) result(answer)
         type(CharacterDim5Len4Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim5Len4Stack
      subroutine pushCharacterDim5Len8Stack(stack, value)
      ...
      function popCharacterDim5Len8Stack(stack, value) result(isSuccess)
         type(CharacterDim5Len8Stack), intent(inout):: stack
         Character(len = 8), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim5Len8Stack(stack) result(answer)
         type(CharacterDim5Len8Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim5Len8Stack
      subroutine pushCharacterDim5Len16Stack(stack, value)
      ...
      function popCharacterDim5Len16Stack(stack, value) result(isSuccess)
         type(CharacterDim5Len16Stack), intent(inout):: stack
         Character(len = 16), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim5Len16Stack(stack) result(answer)
         type(CharacterDim5Len16Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim5Len16Stack
      subroutine pushCharacterDim5Len32Stack(stack, value)
      ...
      function popCharacterDim5Len32Stack(stack, value) result(isSuccess)
         type(CharacterDim5Len32Stack), intent(inout):: stack
         Character(len = 32), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim5Len32Stack(stack) result(answer)
         type(CharacterDim5Len32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim5Len32Stack
      subroutine pushCharacterDim5Len64Stack(stack, value)
      ...
      function popCharacterDim5Len64Stack(stack, value) result(isSuccess)
         type(CharacterDim5Len64Stack), intent(inout):: stack
         Character(len = 64), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim5Len64Stack(stack) result(answer)
         type(CharacterDim5Len64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim5Len64Stack
      subroutine pushCharacterDim5Len128Stack(stack, value)
      ...
      function popCharacterDim5Len128Stack(stack, value) result(isSuccess)
         type(CharacterDim5Len128Stack), intent(inout):: stack
         Character(len = 128), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim5Len128Stack(stack) result(answer)
         type(CharacterDim5Len128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim5Len128Stack
      subroutine pushCharacterDim5Len256Stack(stack, value)
      ...
      function popCharacterDim5Len256Stack(stack, value) result(isSuccess)
         type(CharacterDim5Len256Stack), intent(inout):: stack
         Character(len = 256), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim5Len256Stack(stack) result(answer)
         type(CharacterDim5Len256Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim5Len256Stack
      subroutine pushCharacterDim5Len512Stack(stack, value)
      ...
      function popCharacterDim5Len512Stack(stack, value) result(isSuccess)
         type(CharacterDim5Len512Stack), intent(inout):: stack
         Character(len = 512), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim5Len512Stack(stack) result(answer)
         type(CharacterDim5Len512Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim5Len512Stack
      subroutine pushCharacterDim5Len1024Stack(stack, value)
      ...
      function popCharacterDim5Len1024Stack(stack, value) result(isSuccess)
         type(CharacterDim5Len1024Stack), intent(inout):: stack
         Character(len = 1024), dimension(:, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim5Len1024Stack(stack) result(answer)
         type(CharacterDim5Len1024Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim5Len1024Stack
      subroutine pushCharacterDim6Len1Stack(stack, value)
      ...
      function popCharacterDim6Len1Stack(stack, value) result(isSuccess)
         type(CharacterDim6Len1Stack), intent(inout):: stack
         Character(len = 1), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim6Len1Stack(stack) result(answer)
         type(CharacterDim6Len1Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim6Len1Stack
      subroutine pushCharacterDim6Len2Stack(stack, value)
      ...
      function popCharacterDim6Len2Stack(stack, value) result(isSuccess)
         type(CharacterDim6Len2Stack), intent(inout):: stack
         Character(len = 2), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim6Len2Stack(stack) result(answer)
         type(CharacterDim6Len2Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim6Len2Stack
      subroutine pushCharacterDim6Len4Stack(stack, value)
      ...
      function popCharacterDim6Len4Stack(stack, value) result(isSuccess)
         type(CharacterDim6Len4Stack), intent(inout):: stack
         Character(len = 4), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim6Len4Stack(stack) result(answer)
         type(CharacterDim6Len4Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim6Len4Stack
      subroutine pushCharacterDim6Len8Stack(stack, value)
      ...
      function popCharacterDim6Len8Stack(stack, value) result(isSuccess)
         type(CharacterDim6Len8Stack), intent(inout):: stack
         Character(len = 8), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim6Len8Stack(stack) result(answer)
         type(CharacterDim6Len8Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim6Len8Stack
      subroutine pushCharacterDim6Len16Stack(stack, value)
      ...
      function popCharacterDim6Len16Stack(stack, value) result(isSuccess)
         type(CharacterDim6Len16Stack), intent(inout):: stack
         Character(len = 16), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim6Len16Stack(stack) result(answer)
         type(CharacterDim6Len16Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim6Len16Stack
      subroutine pushCharacterDim6Len32Stack(stack, value)
      ...
      function popCharacterDim6Len32Stack(stack, value) result(isSuccess)
         type(CharacterDim6Len32Stack), intent(inout):: stack
         Character(len = 32), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim6Len32Stack(stack) result(answer)
         type(CharacterDim6Len32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim6Len32Stack
      subroutine pushCharacterDim6Len64Stack(stack, value)
      ...
      function popCharacterDim6Len64Stack(stack, value) result(isSuccess)
         type(CharacterDim6Len64Stack), intent(inout):: stack
         Character(len = 64), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim6Len64Stack(stack) result(answer)
         type(CharacterDim6Len64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim6Len64Stack
      subroutine pushCharacterDim6Len128Stack(stack, value)
      ...
      function popCharacterDim6Len128Stack(stack, value) result(isSuccess)
         type(CharacterDim6Len128Stack), intent(inout):: stack
         Character(len = 128), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim6Len128Stack(stack) result(answer)
         type(CharacterDim6Len128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim6Len128Stack
      subroutine pushCharacterDim6Len256Stack(stack, value)
      ...
      function popCharacterDim6Len256Stack(stack, value) result(isSuccess)
         type(CharacterDim6Len256Stack), intent(inout):: stack
         Character(len = 256), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim6Len256Stack(stack) result(answer)
         type(CharacterDim6Len256Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim6Len256Stack
      subroutine pushCharacterDim6Len512Stack(stack, value)
      ...
      function popCharacterDim6Len512Stack(stack, value) result(isSuccess)
         type(CharacterDim6Len512Stack), intent(inout):: stack
         Character(len = 512), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim6Len512Stack(stack) result(answer)
         type(CharacterDim6Len512Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim6Len512Stack
      subroutine pushCharacterDim6Len1024Stack(stack, value)
      ...
      function popCharacterDim6Len1024Stack(stack, value) result(isSuccess)
         type(CharacterDim6Len1024Stack), intent(inout):: stack
         Character(len = 1024), dimension(:, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim6Len1024Stack(stack) result(answer)
         type(CharacterDim6Len1024Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim6Len1024Stack
      subroutine pushCharacterDim7Len1Stack(stack, value)
      ...
      function popCharacterDim7Len1Stack(stack, value) result(isSuccess)
         type(CharacterDim7Len1Stack), intent(inout):: stack
         Character(len = 1), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim7Len1Stack(stack) result(answer)
         type(CharacterDim7Len1Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim7Len1Stack
      subroutine pushCharacterDim7Len2Stack(stack, value)
      ...
      function popCharacterDim7Len2Stack(stack, value) result(isSuccess)
         type(CharacterDim7Len2Stack), intent(inout):: stack
         Character(len = 2), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim7Len2Stack(stack) result(answer)
         type(CharacterDim7Len2Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim7Len2Stack
      subroutine pushCharacterDim7Len4Stack(stack, value)
      ...
      function popCharacterDim7Len4Stack(stack, value) result(isSuccess)
         type(CharacterDim7Len4Stack), intent(inout):: stack
         Character(len = 4), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim7Len4Stack(stack) result(answer)
         type(CharacterDim7Len4Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim7Len4Stack
      subroutine pushCharacterDim7Len8Stack(stack, value)
      ...
      function popCharacterDim7Len8Stack(stack, value) result(isSuccess)
         type(CharacterDim7Len8Stack), intent(inout):: stack
         Character(len = 8), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim7Len8Stack(stack) result(answer)
         type(CharacterDim7Len8Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim7Len8Stack
      subroutine pushCharacterDim7Len16Stack(stack, value)
      ...
      function popCharacterDim7Len16Stack(stack, value) result(isSuccess)
         type(CharacterDim7Len16Stack), intent(inout):: stack
         Character(len = 16), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim7Len16Stack(stack) result(answer)
         type(CharacterDim7Len16Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim7Len16Stack
      subroutine pushCharacterDim7Len32Stack(stack, value)
      ...
      function popCharacterDim7Len32Stack(stack, value) result(isSuccess)
         type(CharacterDim7Len32Stack), intent(inout):: stack
         Character(len = 32), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim7Len32Stack(stack) result(answer)
         type(CharacterDim7Len32Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim7Len32Stack
      subroutine pushCharacterDim7Len64Stack(stack, value)
      ...
      function popCharacterDim7Len64Stack(stack, value) result(isSuccess)
         type(CharacterDim7Len64Stack), intent(inout):: stack
         Character(len = 64), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim7Len64Stack(stack) result(answer)
         type(CharacterDim7Len64Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim7Len64Stack
      subroutine pushCharacterDim7Len128Stack(stack, value)
      ...
      function popCharacterDim7Len128Stack(stack, value) result(isSuccess)
         type(CharacterDim7Len128Stack), intent(inout):: stack
         Character(len = 128), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim7Len128Stack(stack) result(answer)
         type(CharacterDim7Len128Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim7Len128Stack
      subroutine pushCharacterDim7Len256Stack(stack, value)
      ...
      function popCharacterDim7Len256Stack(stack, value) result(isSuccess)
         type(CharacterDim7Len256Stack), intent(inout):: stack
         Character(len = 256), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim7Len256Stack(stack) result(answer)
         type(CharacterDim7Len256Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim7Len256Stack
      subroutine pushCharacterDim7Len512Stack(stack, value)
      ...
      function popCharacterDim7Len512Stack(stack, value) result(isSuccess)
         type(CharacterDim7Len512Stack), intent(inout):: stack
         Character(len = 512), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim7Len512Stack(stack) result(answer)
         type(CharacterDim7Len512Stack), intent(in):: stack
         Logical:: answer

         answer = .not.associated(stack%entry)
      end function is_emptyCharacterDim7Len512Stack
      subroutine pushCharacterDim7Len1024Stack(stack, value)
      ...
      function popCharacterDim7Len1024Stack(stack, value) result(isSuccess)
         type(CharacterDim7Len1024Stack), intent(inout):: stack
         Character(len = 1024), dimension(:, :, :, :, :, :, :), allocatable, intent(inout):: value
         Logical:: isSuccess
      ...
      function is_emptyCharacterDim7Len1024Stack(stack) result(answer)
